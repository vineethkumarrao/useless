        ...
        <div className="py-5 relative before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-black/[0.06] before:via-black/10 before:to-black/[0.06]">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor={`${id}-model`} className="font-normal" suppressHydrationWarning>
                Model
              </Label>
            ...
            {/* Response format */}
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor={`${id}-response-format`} className="font-normal" suppressHydrationWarning>
                Response format
              </Label>
              <Select defaultValue="1">
                <SelectTrigger
            ...
            {/* Writing style */}
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor={`${id}-writing-style`} className="font-normal" suppressHydrationWarning>
                Writing style
              </Label>
              <Select defaultValue="1">
                <SelectTrigger
            ...
            {/* Mode */}
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor={`${id}-mode`} className="font-normal" suppressHydrationWarning>
                Mode
              </Label>
              <Select defaultValue="1">
                <SelectTrigger
